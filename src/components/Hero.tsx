    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center px-6 text-center">
        ...
        <p className="mt-6 max-w-xl text-balance text-sm leading-relaxed text-muted sm:text-base">
          5 Phút Cà Phê quay và chụp nội dung cà phê, pha chế và đồ uống theo
          phong cách điện ảnh, ấm áp và chân thực. Sẵn sàng hợp tác cùng các
          thương hiệu F&amp;B muốn kể câu chuyện qua từng khung hình.
        </p>
        <a
          href="#work"
